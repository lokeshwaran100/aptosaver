      ...
      <div className="container relative">
        <div className="flex items-center justify-center">
          <Link href={"/"} className="inline-flex gap-2 border py-2 px-3 rounded-xl border-white border-opacity-30">
            <span className="bg-[linear-gradient(to_right,#F87AFF,#FB93D0,#FFDD99,#C3F0B2)] text-transparent bg-clip-text [-webkit-background-clip:text]">AptoSaver</span>
        ...
        <div className="flex justify-center">
          <p className="text-center text-xl mt-8 max-w-md">
            Grow your money with AptoSaver!<br />Enjoy fixed interest rate on your deposits and unlock daily chances to win big rewards.
          </p>
        </div>
        <div className="flex justify-center mt-8 ">
          <Link href={"/app"}>
            <button className="bg-white text-black py-3 px-5 rounded-xl font-medium shadow-xl">Launch App</button>
          </Link>
        </div>
      </div>
    </div >
